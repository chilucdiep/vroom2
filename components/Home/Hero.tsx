    ...
    <section className={styles.HeroContent}>
      <div className={styles.Left}>
        ...
        <p className="BigCaption">
          ...
          road. Leave four wheels behind and make your mark on the open
          road.
        </p>
      ...
      <Image src={HeroImage} alt="Slingshot" width={1000} height={1300} />
    </section>
    <section className={styles.SocialProof}>
      <div>
        <h3>Jonathan Papadakos</h3>
        <p>
          We had a great ride with the car! We rented the helmets as well
